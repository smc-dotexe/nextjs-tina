  ...
  return (
    <>
      {data?.postConnection.edges.map((postData) => {
        ...
        return (
          <div key={uuidv4()} className="w-1/2">
            <Link
              key={uuidv4()}
              href={`/content/posts/` + post._sys.breadcrumbs.join("/")}
              className=""
            ...
            >
              {/* <h3
                className={`text-red-700 dark:text-white text-3xl lg:text-4xl font-semibold title-font mb-5 transition-all duration-150 ease-out ${
